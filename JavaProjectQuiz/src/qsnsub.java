 ...
 * @author lenovo
 */
public class qsnsub extends javax.swing.JFrame {

    /**
     * Creates new form qsnsub
     */
    public qsnsub() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(qsnsub.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
